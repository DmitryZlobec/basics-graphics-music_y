...
`endif
 ...
 initial begin
   $readmemh("mcu_mem_bank0.hex",mcu_mem_bank0 );
   $readmemh("mcu_mem_bank1.hex",mcu_mem_bank1 );
   $readmemh("mcu_mem_bank2.hex",mcu_mem_bank2 );
   $readmemh("mcu_mem_bank3.hex",mcu_mem_bank3 );
 end
